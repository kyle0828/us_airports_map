...
airports= L.geoJson.ajax("assets/airports.geojson", {
    ...
    attribution: 'Airports Data &copy; Data.gov | US-States &copy; Mike Bostock of D3 | Base Map &copy; CartoDB.DarkMatter | Made By Kyle Chen'
}).addTo(mymap);

// 6. Set function for color ramp
    colors = chroma.scale('GnBu').colors(5); //colors = chroma.scale('OrRd').colors(5);
    ...
    var legend = L.control({position: 'bottomright'});
        ...
        legend.onAdd = function () {
            ...
            div.innerHTML += '<b><p>number of airport</p></b><br />';
